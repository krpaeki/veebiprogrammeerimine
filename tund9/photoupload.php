	...
	if(isset($_POST["submitPic"])) {
		...
		if(!empty($_FILES["fileToUpload"]["name"])){
			...
			// kui kõik korras, laeme üles
				...
				//alpha 0 ... 127
				imagettftext($myImage, 20, 0, 10, 25, $textColor, "../vp_picfiles/ALGER.TTF", $textToImage);
...
?>
	...
	<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="multipart/form-data">
	  ...
	  <input type="radio" name="privacy", value="3"><label>Sisseloginud kasutajale</label>&nbsp;
	  <input type="radio" name="privacy", value="2" checked><label>Isiklik</label>	  
